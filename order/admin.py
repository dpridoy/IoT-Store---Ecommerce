...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id','token','total','emailAddress','created','billingName','billingAddress','billingCity','billingPostcode','billingCountry','shippingName','shippingAddress','shippingCity','shippingPostcode','shippingCountry']
    fieldsets = [
