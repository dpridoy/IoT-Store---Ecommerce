...
class Order(models.Model):
    ...
    total = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Taka Order Total")
...
class OrderItem(models.Model):
    ...
    price=models.DecimalField(max_digits=10,decimal_places=2,verbose_name='BDT Price')
